...
public class CustomMarkerView extends MarkerView {
    ...
    public CustomMarkerView (Context context, int layoutResource, long referenceTimestamp) {
        ...
        this.mDataFormat = new SimpleDateFormat("yyyy-MM-dd HH:mm:ss", Locale.US);
    ...
    public void refreshContent(Entry e, Highlight highlight) {
        ...
        tvContent.setText(e.getY() + "°C at " + getTimedate(currentTimestamp)); // set the entry-value as the display text
    }
